...
function ContextCompactionTimelineRow({
  ...
  return (
    <div className="mx-auto w-full max-w-3xl py-1 text-muted-foreground text-xs">
      <div
        role={canExpand ? "button" : "separator"}
        ...
        className={cn(
          ...
          canExpand &&
            "cursor-pointer rounded-md px-1 hover:bg-accent/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ring/70",
        )}
      >
      ...
      {expanded ? (
        <div className="mx-auto mt-1 max-w-3xl whitespace-pre-wrap rounded-md bg-muted/40 px-3 py-2 text-secondary-label text-xs">
          {detail}
        </div>
      ) : null}
    </div>
