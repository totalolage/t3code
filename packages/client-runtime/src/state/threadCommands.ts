...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    unhide: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:unhide",
      execute: (input: UnhideThreadInput) => unhideThread(input),
      scheduler,
      concurrency,
    }),
